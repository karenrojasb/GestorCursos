...
async function exportarCursoAExcel(curso: Curso) {
  ...
  const datosInscritos = inscritosCurso.map((Inscritos) => ({
    Documento: Inscritos.docInscr,
    Nombre: Inscritos.nombreInscrito,
    FechaInscripción: Inscritos.fecreg,
    Nota: Inscritos.nota,
    Especificación: Inscritos.especificacion,
    RegistradoPor: Inscritos.nombreRegistrador,
    FechaRegistro: Inscritos.fechaRegistro,
  }));
