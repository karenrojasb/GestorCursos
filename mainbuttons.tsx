...
import Reportes from "../user/Reportes/page";
...
export default function MainButtons({ onSelect, publico, esAdmin, esProfesor }: MainButtonsProps) {
      ...
      <div className="p-6 rounded-lg shadow-lg fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        ...
        {esAdmin && (
          <>
            ...
            {showReportes && <Reportes onClose={() => setShowReportes(false)} />}
          </>
        )}
      </div>
