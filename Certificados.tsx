...
<table className="w-full border-collapse border border-gray-300 text-center">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      <label>Horas</label>
      <input type="number" name="Horas" value={formData.Horas} onChange={handleChange} className="w-full border p-2 rounded-lg" />
    </div>
    <div>
      <label>Cupo máximo</label>
      <input type="number" name="CupoMax" value={formData.CupoMax} onChange={handleChange} className="w-full border p-2 rounded-lg" />
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      <label>Línea</label>
      <select name="Linea" value={formData.Linea} onChange={handleChange} className="w-full border p-2 rounded-lg">
        <option value="">Selecciona una opción</option>
    ...
    <div>
      <label>Estado</label>
      <select name="Estado" value={formData.Estado} onChange={handleChange} className="w-full border p-2 rounded-lg">
        <option value="">Selecciona una opción</option>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      ...
      <select name="Modalidad" value={formData.Modalidad} onChange={handleChange} className="w-full border p-2 rounded-lg">
        <option value="">Selecciona una opción</option>
    ...
    <div>
      <label>Unidad</label>
      <select name="Unidad" value={formData.Unidad} onChange={handleChange} className="w-full border p-2 rounded-lg">
        <option value="">Selecciona una opción</option>
        {unidad.map((u) => (
  ...
  <div>
    ...
    <input type="text" name="Proexterno" value={formData.Proexterno} onChange={handleChange} className="w-full border p-2 rounded-lg" />
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      ...
      <input type="date" name="InicioInscr" value={formData.InicioInscr} onChange={handleChange} className="w-full border p-2 rounded-lg" />
    </div>
    <div>
      <label>Fin Inscripciones</label>
      <input type="date" name="FinInscr" value={formData.FinInscr} onChange={handleChange} className="w-full border p-2 rounded-lg" />
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      ...
      <select name="IdTipoCurso" value={formData.IdTipoCurso} onChange={handleChange} className="w-full border p-2 rounded-lg">
        <option value="">Selecciona una opción</option>
