...
export default function RootLayout({ children }: LayoutProps) {
  ...
  if (!usuario) {
    return (
      <html lang="es">
        <body className="seleccion-personalizada flex items-center justify-center h-screen bg-gray-200">
...
<div
  className="absolute bottom-0 right-0 w-[700px] h-[500px] z-0"
  style={{
...
<div
  className="absolute bottom-0 right-0 w-[700px] h-[500px] bg-no-repeat bg-cover z-[-1]"
  style={{
...
></div> 
        ...
        <header className="w-full flex items-center justify-between px-6 py-2 bg-white shadow-md">
          ...
          <span className="text-xl font-medium text-gray-800 seleccion-personalizada">
  {usuario.nombre}
</span>
            <button
              className="border seleccion-personalizada text-[#990000]  border-[#990000] px-2 py-1 rounded hover:bg-[#990000] hover:text-white transition"
        ...
        <motion.h1
  className="text-4xl font-bold text-[#990000] mb-6 text-center seleccion-personalizada"
...
>
  Bienvenido a Gestión de Cursos
        ...
        <footer className="bg-white items-center  py-2 shadow-inner w-full">
            ...
            <p className="text-gray-700 text-center seleccion-personalizada">
