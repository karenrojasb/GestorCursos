...
/>
          ...
          <div className="modal-actions p-3 flex justify-center gap-3">
            <button type="submit"
             className="mt-6 h-14 w-44 bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg hover:scale-105 transition">
              Actualizar
              </button>
            <button 
            type="button" 
            onClick={onClose}
            className="mt-6 h-14 w-44 bg-[#990000]  hover:bg-red-700 text-white py-2 rounded-lg hover:scale-105 transition">
              Cancelar
            </button>
          </div>
        </form>
